...
namespace ABIPlugins {
	...
	public class BasePopup : MonoBehaviour {
		...
		public virtual void Awake () {
			...
			refStacks = PopupManagerAbi.Instance.popupStacks;
		...
		public void Reshow () {
			...
			PopupManagerAbi.Instance.ChangeTransparentOrder(mTransform, true);
		}
		...
		void Destroy () {
			...
			if (hideCompletedCallback != null)
				hideCompletedCallback();
            PopupManagerAbi.Instance.ChangeTransparentOrder(mTransform, false);
            PopupManagerAbi.Instance.ResetOrder();
		}
